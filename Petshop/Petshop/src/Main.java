...
public class Main {
  ...
  private static void verifyWater() {
    ...
    System.out.println("A máquina está no momento com " + amountWater + " litro(s) de água");
  }

  private static void verifyShampoo() {
    var amountShampoo = petMachine.getShampoo();
    System.out.println("A máquina está no momento com " + amountShampoo + " litro(s) de shampoo");
  }
